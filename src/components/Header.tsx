...
const Header = () => {
  return (
    <header className="bg-gradient-to-r from-pink-500 to-pink-600 text-white py-8">
      <div className="container mx-auto px-4">
        ...
        <div className="flex justify-center space-x-8 mt-6">
          <div className="flex items-center">
            <Clock className="w-5 h-5 mr-2 text-pink-200" />
            <span className="text-sm">Horário Flexível</span>
          </div>
          <div className="flex items-center">
            <Shield className="w-5 h-5 mr-2 text-pink-200" />
